...
/*   Updated: 2023/09/29 15:53:13 by jmarinho         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_execute_only_cmd(t_minishell *ms, t_cmd *curr, char *cmd) //arranjar maneira de os builtins trabalharem no parent (p ex o exit!)
{
	pid_t	pid;
...
void	ft_execute_cmd(t_minishell *ms, t_cmd *curr, char *cmd)
{
	if (ft_strncmp(cmd, "echo", 5) == 0)
		...
		ft_export(ms, curr);//parent
	else if (ft_strncmp(cmd, "unset", 6) == 0)
		ft_unset(ms, curr);//parent
